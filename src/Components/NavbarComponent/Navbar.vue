...
<template>
    <nav
        class="flex justify-between items-center h-[7.692vh] max-h-16 mx-auto my-0 bg-custom-blue-opacity sm:justify-between sm:text-l sm:max-h-20 sm:h-[13.311vh] lg:text-l lg:max-h-24 xl:text-xl xl:max-h-32">
        <div class="flex items-center">
            <img src="../../assets/Logo.svg"
                class="h-12 w-12 ml-5 cursor-pointer sm:ml-[3vw] sm:h-12 sm:w-12 lg:h-15 lg:w-15 xl:h-18 xl:w-18" />
            <span class="text-white sm:mr-[4.3vw] sm:ml-[4.3vw] hidden xl:block">Mateusz Zaniewski</span>
        </div>

        <span class="text-white sm:mr-[4.3vw] sm:ml-[4.3vw] xl:hidden">Mateusz Zaniewski</span>
